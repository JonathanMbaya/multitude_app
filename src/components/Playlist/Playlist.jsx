...
function Playlist() {
  ...
  const youtubePlaylist =
    "https://www.youtube.com/embed/videoseries?si=qNZTvNlbDKisy1Qg&amp;list=PLEiHuyQJJ1QVYQehdUjHap0MNJOGt6Kpa";
  ...
  return (
    <div className="music-container">
      <div className="info-playlist">
        ...
        <p>
          Multitude vous propose chaque mois sa playlist préparée pour vous sur
          mesure , les coups de coeurs de la rédaction et les tendances à ne pas
          manquer.
        </p>
      </div>
      ...
      <div className="playlist-container">
        {embedUrl ? (
          ...
          <p className="error-message">
            Aucune playlist disponible pour cette URL.
          </p>
        )}
      </div>
    </div>
