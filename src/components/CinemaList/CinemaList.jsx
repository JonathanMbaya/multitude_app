...
function CinemaList() {
  ...
  useEffect(() => {
    const fetchMovies = async () => {
      try {
        const response = await axios.get(`${import.meta.env.VITE_API_BASE_URL}/films`);
  ...
  return (
    <div className="cinema-list">
      ...
      <p>
        Multitude vous propose son top 6 de films chaque mois, des coups de cœur de la rédaction :
        de la romance, du suspense, du drame, des classiques... Vous aurez toujours un film à regarder pour la soirée.
      </p>
