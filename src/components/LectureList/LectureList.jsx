...
function LectureList() {
  ...
  useEffect(() => {
    ...
    const fetchBooks = async () => {
      try {
        const response = await axios.get(`${import.meta.env.VITE_API_BASE_URL}/livres`); // Requête avec axios
  ...
  return (
    <div className="lecture-list">
      ...
      <p>
        ...
        des coups de coeur de la rédaction : <br /> 
        de la romance, du suspense, du drame, des classiques, vous aurez 
      ...
      {selectedBook && (
        <div className="modal">
          <div className="modal-content">
            <button style={{ color: 'black' }} className="close-modal" onClick={() => setSelectedBook(null)}>
              <CircleX />
            </button>
