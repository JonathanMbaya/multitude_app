...
function AdminLibrary() {
  ...
  const handleSubmit = async (itemData) => {
    try {
      ...
      console.error(
        `Erreur lors de la ${editingItem ? "modification" : "création"} d'un ${formType}:`,
        error,
      );
    }
  };
    ...
    <>
      ...
      <div className="admin-library">
        ...
        <div className="tabs">
          ...
          <button
            className={activeTab === "livres" ? "active" : ""}
            ...
            <div key={item.id} className="item-card">
              ...
              {activeTab === "films" ? (
                <>
                  <p style={{ color: "black" }}>
                    Sortie:{" "}
                    {new Date(item.dateSortie).toLocaleDateString("fr-FR")}
                  </p>
                </>
              ) : (
                <>
  ...
  return (
    <div className="overlayy">
      ...
      >
        ...
        <h3>
          {editingItem ? "Modifier" : "Ajouter"} un{" "}
          {type === "films" ? "film" : "livre"}
        </h3>
